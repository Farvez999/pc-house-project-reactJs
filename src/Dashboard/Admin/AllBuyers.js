...
const AllBuyers = () => {
    const { data: buyers = [], refetch } = useQuery({
        queryKey: ['users'],
        queryFn: async () => {
            const res = await fetch(`https://used-products-resale-server-vert.vercel.app/allUser/Buyer`);
    ...
    const handleDeleteDoctor = buyer => {
        ...
        fetch(`https://used-products-resale-server-vert.vercel.app/buyers/${buyer._id}`, {
            method: 'DELETE',
            headers: {
