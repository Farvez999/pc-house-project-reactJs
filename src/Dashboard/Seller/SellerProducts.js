...
const SellerProducts = () => {
    ...
    const { data: products, isLoading, refetch } = useQuery({
        ...
        queryFn: async () => {
            try {
                const res = await fetch(`https://used-products-resale-server-vert.vercel.app/products/${user.email}`, {
                    headers: {
    ...
    const addAdvertise = id => {
        ...
        fetch(`https://used-products-resale-server-vert.vercel.app/addProduct/addAdvertisement/${id}`, {
            method: 'PUT',
            headers: {
    ...
    const removeAdvertise = (id) => {
        fetch(`https://used-products-resale-server-vert.vercel.app/addProduct/removeAdvertisement/${id}`, {
            method: 'PUT',
            headers: {
    ...
    const handleDelete = product => {
        fetch(`https://used-products-resale-server-vert.vercel.app/products/${product._id}`, {
            method: 'DELETE',
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
